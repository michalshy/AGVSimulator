...
class PredicitonModel:
    def __init__(self):
        self._tms_data = []
        self._steps = 20
        self._initial_data = pd.DataFrame()
        self._conn = None

    def SetTmsData(self, tms_data):
        self._tms_data = tms_data

    def SetSteps(self, steps):
        self._steps = steps

    def SetInitialData(self, initial_data):
